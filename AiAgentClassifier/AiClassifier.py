...
if __name__ == "__main__":
    ...
    result = service.gpt(
        """
        ID: 3912100526, Наименование: СВЕРЛО С ЦИЛИНДРИЧЕСКИМ ХВОСТОВИКОМ, Маркировка: ИНСТУЛС 00001243814, Регламенты (ГОСТ/ТУ): Неизвестно, Параметры: D=8 L=79, OKPD2_NAME: Сверла из быстрорежущей стали, ГОСТ Название: Неизвестно        """,

        "classifier_system_prompt", "classifier_basic_prompt")
    print('\n')
    print("\n")
