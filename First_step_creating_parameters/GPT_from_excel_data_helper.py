...
class GptDataProcessor:
    ...
    Обрабатывает только первые 20 строк каждого листа.
    """
    ...
    def process_data(self):
        ...
        try:
            ...
            for group_id in group_ids:
                ...
                # Проходимся по всем строкам, начиная со второй, до достижения 20
                for row in sheet.iter_rows(min_row=2, min_col=8, max_col=8):
                    if processed_rows >= 20:
                        print(f"Достигнуто ограничение в 20 строк для листа '{sheet_name}'. Прекращаем обработку.")
                        break
